...
export default function TwoFactorSettings() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center py-10"><Loader2 className="w-6 h-6 animate-spin text-teal-500" /></div>;
  }
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input type="text" inputMode="numeric" maxLength={6} value={code}
            ...
            placeholder="••••••"
            className="w-full h-12 rounded-xl border border-teal-100 bg-teal-50/40 text-center text-2xl tracking-[0.4em] font-bold focus:outline-none focus:border-teal-400" />
        </div>
      ...
      {factor ? (
        <div className="bg-teal-50 border border-teal-100 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="font-semibold text-teal-700">Đã bật xác thực 2 lớp</div>
            <div className="text-sm text-teal-600/80 mt-0.5">Mỗi lần đăng nhập sẽ cần mã 6 số từ ứng dụng Authenticator.</div>
