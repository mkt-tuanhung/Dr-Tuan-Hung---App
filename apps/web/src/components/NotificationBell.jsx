...
export default function NotificationBell() {
  ...
  // Mở chuông = coi như đã đọc hết → badge biến mất ngay
  const toggleBell = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={toggleBell} className="relative w-10 h-10 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-600">
