...
export const ROLES = {
  wolf: {
    ...
    power: 'Mỗi đêm cả bầy Sói cùng thức dậy, bí mật thống nhất chọn 1 người trong làng để ăn thịt — người đó bị loại vào sáng hôm sau (trừ khi được Bảo Vệ che hoặc Phù Thủy cứu). Ban ngày bạn hoà vào dân làng, tranh luận và bỏ phiếu như người vô tội để không bị nghi.',
  ...
  villager: {
    ...
    power: 'Bạn không có phép thuật — vũ khí là cái đầu và lá phiếu. Ban đêm bạn ngủ. Ban ngày cùng cả làng thảo luận, phân tích lời khai, vạch mặt kẻ khả nghi và bỏ phiếu treo cổ người bị nghi là Sói. Dân làng đoàn kết chính là sức mạnh.',
  ...
  seer: {
    ...
    power: 'Mỗi đêm bạn chỉ vào 1 người, quản trò sẽ cho bạn biết người đó là \'Sói\' hay \'không phải Sói\' (không nói rõ vai). Đây là thông tin quý nhất của phe Dân. Ban ngày khéo léo dẫn dắt cả làng bỏ phiếu đúng, nhưng đừng lộ mình quá sớm kẻo bị Sói cắn.',
  ...
  witch: {
    ...
    power: 'Bạn có 2 bình thuốc, mỗi bình chỉ dùng 1 lần cả ván. Bình CỨU: đêm nào biết ai bị Sói cắn, bạn cứu sống được người đó. Bình ĐỘC: giết chết 1 người bạn nghi là Sói. Mỗi đêm quản trò sẽ hỏi bạn có dùng thuốc không.',
  ...
  hunter: {
    ...
    power: 'Ban đêm bạn ngủ bình thường. Nhưng khi bị loại (dù bị Sói cắn hay bị làng treo cổ), trước khi ra đi bạn được chỉ tay bắn chết thêm 1 người bất kỳ. Luôn nhắm sẵn kẻ đáng ngờ nhất để phát súng cuối không lãng phí.',
  ...
  guard: {
    ...
    power: 'Mỗi đêm bạn chọn 1 người để bảo vệ; nếu đêm đó Sói tấn công đúng người ấy thì họ sống sót. Không được bảo vệ cùng 1 người 2 đêm liên tiếp, nhưng có thể tự bảo vệ mình. Không ai biết đêm qua bạn đã cứu ai.',
  ...
  cupid: {
    ...
    power: 'Chỉ hành động ĐÊM ĐẦU TIÊN: bạn chọn 2 người bất kỳ thành một cặp người yêu. Từ đó nếu 1 trong 2 chết, người kia đau lòng chết theo ngay. Nếu ghép 1 Sói với 1 Dân, cặp đôi thành phe thứ ba — chỉ cần 2 người sống sót bên nhau là thắng.',
  ...
  mayor: {
    ...
    power: 'Bạn là người có tiếng nói nặng ký nhất làng: mỗi lần bỏ phiếu ban ngày, phiếu của bạn tính bằng 2 phiếu thường. Không có kỹ năng ban đêm. Hãy dùng uy tín để dẫn dắt làng bỏ phiếu đúng hướng.',
