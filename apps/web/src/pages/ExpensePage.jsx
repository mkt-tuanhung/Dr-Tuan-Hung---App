      ...
      <div className="min-h-screen bg-background pb-12">
        <header className="bg-card border-b border-border px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-bold text-lg flex items-center gap-2">
              <Receipt className="w-5 h-5 text-destructive" /> Quản lý chi phí
            </h1>
          </div>
          <Button onClick={() => openModal()} className="bg-destructive hover:bg-destructive/90 text-destructive-foreground">
        ...
        <Dialog open={modalOpen} onOpenChange={setModalOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>{editingId ? 'Cập nhật chi phí' : 'Thêm khoản chi'}</DialogTitle>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input type="number" value={amount} onChange={e => setAmount(e.target.value)} placeholder="VD: 500000" />
              </div>
              <div className="space-y-2">
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSubmit} disabled={submitting} className="bg-destructive hover:bg-destructive/90 text-destructive-foreground">
